# -*- coding: utf-8 -*-
"""
This script logs into ivasms.com using a headless Selenium environment on
Railway, fetches SMS messages, filters for new OTPs, and sends them to Telegram.
This is the final, production-ready version for professional hosting.
...
# On Railway, you will set these in the "Variables" tab.
EMAIL = os.environ.get("EMAIL", "s77shahidul@gmail.com")
PASSWORD = os.environ.get("PASSWORD", "s77shahidul")
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "7924086431:AAGQVgbVbG1O_dkqo3t4uGIkuwETc_GQouo")
TELEGRAM_CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID", "-1002156267437")
...
def setup_driver():
    """Initializes the Selenium WebDriver for a Docker/Linux environment."""
    options = webdriver.ChromeOptions()
    options.add_argument('--headless')
    options.add_argument('--no-sandbox')
    options.add_argument('--disable-dev-shm-usage')
    options.add_argument("--window-size=1920,1080") # Set a reasonable window size
    logging.info("Starting headless Chrome browser for Railway...")
